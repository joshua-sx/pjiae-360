    ...
    const validateFileType = useCallback(
        (file: File): FileError | null => {
            ...
            const isValidType = acceptedFileTypes.some((type) => {
                ...
                return fileType.match(type.toLowerCase());
            });
                                ...
                                {status === "idle" || status === "dragging" ? (
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={resetState}
                                            type="button"
                                            className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-muted px-4 py-2.5 text-sm font-semibold text-foreground transition-all duration-200 hover:bg-muted/80"
                                        >
                                            Cancel
                                        </button>
                                    </motion.div>
