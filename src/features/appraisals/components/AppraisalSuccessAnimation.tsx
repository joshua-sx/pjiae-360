            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  size="lg"
                  onClick={onStartNew}
                  className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground font-semibold px-8 py-4 text-lg"
                >
                  Start New Appraisal
        ...
        {currentStep >= 3 && (
          <>
            {[...Array(6)].map((_, i) => (
              ...
              >
                <div className="w-8 h-8 bg-gradient-to-br from-primary/40 to-primary/20 rounded-full opacity-20" />
              </motion.div>
            ))}
          </>
        )}
