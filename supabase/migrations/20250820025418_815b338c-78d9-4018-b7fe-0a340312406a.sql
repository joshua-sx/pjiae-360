...
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'self_assessment';
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'manager_review';
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'calibration';
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'finalization';
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'acknowledgment';
ALTER TYPE appraisal_phase ADD VALUE IF NOT EXISTS 'complete';
