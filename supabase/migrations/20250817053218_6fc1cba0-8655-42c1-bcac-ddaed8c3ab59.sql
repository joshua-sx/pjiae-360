...
-- Security Fix 3: Drop and recreate claim_employee_invitation function with new signature
DROP FUNCTION IF EXISTS public.claim_employee_invitation(text, uuid);
